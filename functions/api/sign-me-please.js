import { Keypair } from '../solana/keypair';
import { Transaction } from '../solana/transaction';
...
export const onRequest = async (
  event,
    ...
    const jsonResponse = JSON.stringify({txn: serializedTxn, cms: candyMachineSigner.toString()}, null, 2);
